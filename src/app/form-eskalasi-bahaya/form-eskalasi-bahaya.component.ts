...
@Component({
  selector: 'app-form-eskalasi-bahaya',
  templateUrl: './form-eskalasi-bahaya.component.html',
  styleUrls: ['./form-eskalasi-bahaya.component.scss'],
  providers:[FormTransportComponent]
})
export class FormEskalasiBahayaComponent implements OnInit {
  ...
  getQuestionInit(){
    ...
    let params = {
      ...
      survey_id: '868ff7dd-fccd-0274-0532-73288eaa19eb',
