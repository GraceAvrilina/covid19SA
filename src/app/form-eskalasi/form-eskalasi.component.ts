...
@Component({
  selector: 'app-form-eskalasi',
  templateUrl: './form-eskalasi.component.html',
  styleUrls: ['./form-eskalasi.component.scss'],
  providers:[FormTransportComponent]
})
export class FormEskalasiComponent implements OnInit {
  ...
  getQuestionInit(){
    ...
    let params = {
      ...
      survey_id: '31687ee4-f30d-4454-a157-40b9d4245659',
  ...
  onSubmit(data) {
    ...
    // if(this.b1 == true && data.input_q7 == null){
    //   this.presentToast("Salah satu data masih kosong")
    // }
    // else if(this.b1 == false && (this.b2 == true || this.b3 == true || this.b4 == true ||this.b5 == true)){
    //   if(data.input_q7 == null)
    //   this.presentToast("Salah satu data masih kosong")
    // }
    // // else if(this.b1 == false && (this.b2 == false || this.b3 == false || this.b4 == false ||this.b5 == false)){
    // //   this.presentToast("Salah satu data masih kosong")
    // // }
    // else{
  ...
  changestatus( val, no){
    ...
    else if((val == 3 || val==4) && no == 'input_q4'){
    this.b4 = true
    this.b5 = true
    this.no5 = val
    }
