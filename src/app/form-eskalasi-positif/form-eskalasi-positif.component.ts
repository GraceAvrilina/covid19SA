...
@Component({
  selector: 'app-form-eskalasi-positif',
  templateUrl: './form-eskalasi-positif.component.html',
  styleUrls: ['./form-eskalasi-positif.component.scss'],
  providers:[FormTransportComponent]
})
export class FormEskalasiPositifComponent implements OnInit {
  ...
  getQuestionInit(){
    ...
    let params = {
      ...
      survey_id: '716eccb8-fa03-0854-d1ed-fdce60bf61fa',
  ...
  changestatus( val, no){
    console.log(val, no)
    if( val==2 && no == 'input_q0'){
      this.b1 = false
      this.b2 = false
      this.no1 = val
    }
    else if(val == 1 && no == 'input_q0'){
    this.b1 = true
    this.b2 = true
    this.no1 = val
    }
    
    if(val == 3 && no == 'input_q1'){
      this.b2 = false
      this.no2 = val
    }
    else if((val == 1 || val==2) && no == 'input_q1'){
    this.b2 = true
    this.no2 = val
    }
  }
